...
$_SG['servidor'] = 'mysql.diariodecodigos.info';    // Servidor MySQL
$_SG['usuario'] = 'diariodecodigo03';          // Usuсrio MySQL
$_SG['senha'] = 'onibusca';                // Senha MySQL
$_SG['banco'] = 'diariodecodigo03';            // Banco de dados MySQL

$_SG['paginaLogin'] = 'login.php'; // Pсgina de login

$_SG['tabela'] = 'TB_PASSAGEIRO';       // Nome da tabela onde os usuсrios sуo salvos
// ==============================
...
$sql = "SELECT `IDT_PASSAGEIRO`, `LOGIN` , `NOME` FROM `".$_SG['tabela']."` WHERE ".$cS." `login` = '".$nusuario."' AND ".$cS." `senha` = '".$nsenha."' LIMIT 1";
...
setcookie("usuarioID", $resultado['IDT_PASSAGEIRO']);

setcookie("usuarioNome", $resultado['NOME']);

$_SESSION['usuarioID'] = $resultado['IDT_PASSAGEIRO']; // Pega o valor da coluna 'id do registro encontrado no MySQL
