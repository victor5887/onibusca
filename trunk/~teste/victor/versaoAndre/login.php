...
function validacao(){
    ...
    alert("O campo Dia não foi preenchido");
    document.form.dia.focus();
    return false;
    }
    if (document.form.mes.value == ""){
    alert("O campo Mes não foi preenchido");
    document.form.mes.focus();
    return false;
    }
    if (document.form.ano.value == ""){
    alert("O campo Ano não foi preenchido");
...
<table border="0" cellpadding="0" height="23" width="835" style="border-collapse: collapse">
        ...
        <table border="0" cellpadding="0" cellspacing="0" height="222" width="836">
          <tbody>
            <tr>
             <td height="100"> &nbsp;</td>
            <td height="222" width="822"> 
				<table border="0" cellpadding="0" cellspacing="0" height="156" width="487">
                	<tbody>
                		<tr> 
                  			<td style="background-position: left bottom; background-repeat: no-repeat;" alt="" background="arquivos/pic8_2.htm" bgcolor="#ffffff" height="156" width="487"> 
                					...
                					<tr> 
                  						<td alt="" bgcolor="#ffffff" height="73" width="525">
                  							<div style="padding-top: 15px; padding-left: 15px; padding-right: 10px;"> 
                      							<table id="table2" border="0" cellpadding="0" cellspacing="0" height="104" width="458">
                        							<tbody>
                        								<tr> 
                         							   		<td width="13">
                          									...
                          									<td width="487">
                          										<span class="t14">
                          											<strong>&nbsp; Login - Entrar 
																Web Site</strong></span><div style="margin: 1ex;">
																	<div>
          ...
          <tbody><tr>
	    	...
	    	<form action="lib/valida.php" method="post" nctype="multipart/form-data" name="form" id="form" onsubmit="return validacao();">
                                ...
                                <table class="txt10_cinza" align="center" border="0" cellpadding="2" cellspacing="0" width="437"> 
                                  ...
                                  <tr> 
                                    <td class="txt_black_bold" align="right" width="92" height="32">
